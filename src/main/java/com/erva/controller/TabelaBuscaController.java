...
public class TabelaBuscaController {
    ...
    ObservableList<Entrega> lista;
    public void carregarEntregas(ArrayList<Entrega> entregas) {
        lista = FXCollections.observableArrayList(entregas);
